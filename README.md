...
Download [`install-tbx-markdown.tbx`](https://github.com/jacobio/tbx-markdown/releases/download/v1.0/install-tbx-markdown.tbx) and open it in Tinderbox. It contains one note with the installer action code — just copy-and-paste into any Tinderbox to add the enhanced Markdown prototype.
